...
namespace ChatApp.Controllers
{
    ...
    public class GroupController : ControllerBase
    {
        ...
        public IActionResult CreateGroup([FromForm] CreateGroupModel createGroup, [FromBody] string username )
        {
        ...
        [HttpPost("GetGroup")]
        public IActionResult GetGroupDetail([FromBody] int groupId, [FromBody] string username)
        {
        ...
        public IActionResult GetAllProfiles([FromBody] int groupId, [FromBody] string username)
        {
        ...
        [HttpPost("LeaveGroup")]
        public IActionResult LeaveGroup([FromBody] int groupId, [FromBody] string username)
        {
        ...
        public IActionResult MakeAdmin(int groupId, [FromBody] string[] selUserName, [FromBody] string username)
        {
        ...
        public IActionResult RemoveUser(int groupId, [FromBody] string[] selUserName, [FromBody] string username)
        {
